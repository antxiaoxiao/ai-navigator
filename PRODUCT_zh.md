...
AI 个性化学习路径市场规模 2026 年达 60 亿美元，预计 2030 年增至 164 亿美元，年复合增长率 28.6%。这是一个真实的大市场，但现有产品分为三个层次，与你的产品定位各不相同：

**层次一：企业 LMS（不是竞争对手）**
Docebo、360Learning、Cornerstone——面向企业 HR/L&D，重点是合规培训、技能评估、课程管理。
产品冰冷、打卡逻辑、用户体验差。目标用户是公司 HR，不是个人学习者。

**层次二：个人职业发展平台（部分重叠，可差异化）**
LinkedIn Learning、Coursera、Pluralsight——内容丰富但通用。
缺乏个人上下文，不能告诉你"这对你意味着什么"。没有知识框架，没有每日资讯定位。

**层次三：AI 个人助理 / AI OS（最接近长期愿景，但方向不同）**
Rewind、Dume.ai、Lindy、Apple Intelligence、Microsoft Copilot——跨工具连接、上下文感知、任务执行。
这些产品做的是效率层，不是成长层。没有知识框架，没有编辑立场，没有职业方向叙事。

### 真正的市场空白

没有任何现有产品同时做到这四件事：
1. 系统性 AI 知识框架（让人理解全局）
2. 每日资讯 + 框架定位（让资讯有坐标）
3. 个人成长叙事（告诉你这对你意味着什么）
4. 编辑判断而非算法推荐（有立场，有品味）
...
| | 大厂（Apple / Copilot） | 课程平台（Coursera） | 你的产品 |
|---|---|---|---|
| 核心价值 | 效率 | 知识获取 | 方向感 + 成长叙事 |
| 有编辑立场 | ❌ | ❌ | ✅ |
| 系统知识框架 | ❌ | ❌ | ✅ |
| 个人化程度 | 工具层 | 行为数据 | 真正认识你 |
| 可被替代风险 | 会做效率更好 | 内容更多 | 灵魂无法复制 |
